...
export default function Settings() {
  const {
    locationName, posItems, learnedMappings,
    saveLocationName, savePosItems, setLearnedMappings, clearHistory,
  } = useStore();
  ...
  return (
    <div style={{ paddingTop: 16 }}>
      ...
      <div className="card" style={{ marginBottom: 12 }}>
        ...
        <p style={{ fontSize: 11, color: 'var(--text3)', margin: '0 0 10px' }}>
          Saved when you manually match or accept a fuzzy-matched item.
        </p>
